...
import com.veteran.presency.view.history.HistoryAdapter.HistoryAdapterCallback
import com.veteran.presency.viewmodel.HistoryViewModel
...
class HistoryActivity : AppCompatActivity(), HistoryAdapterCallback {
    ...
    override fun onDelete(modelDatabase: ModelDatabase?) {
        ...
        alertDialogBuilder.setMessage("Hapus riwayat absen ini?")
