package com.veteran.presency.view.history
...
import com.veteran.presency.utils.BitmapManager.base64ToBitmap
...
class HistoryAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvMatkul.text = data.matkul
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var tvMatkul: TextView = itemView.tvMatkul
        var tvNomor: TextView = itemView.tvNomor
        var tvNama: TextView = itemView.tvNama
        var tvNIM: TextView = itemView.tvNIM
        ...
        var tvKeterangan: TextView = itemView.tvKeterangan
